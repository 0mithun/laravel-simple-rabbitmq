...
namespace Mithun\SimpleRabbit\MQ;
...
class Definition
{
     ...
     *
     */
    public function defineExchange(string $name, $type = 'direct', $durable = true): ?array
    {
     ...
     *
     */
    public function bindQueue(string $queue_name, $exchange,     $routing_key = ''): ?array
    {
